...
public class ChessMatch {
	...
	public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
		...
		if (testCheck(currentPlayer)) {
			...
			throw new ChessException("Erro, nao se pode colocar em posicao de check");
		}
	...
	public ChessPiece replacePromotedPiece(String type) {
		if (promoted == null) {
			throw new IllegalStateException("Nao a nenhuma peca para promover");
		}
	...
	private ChessPiece king(Color color) {
		...
		throw new IllegalStateException("Nao existe o rei desta cor");
	}
	...
	private boolean testCheck(Color color) {
		...
		for (Piece p : opponentPieces) {
			...
			if (temp[kingPosition.getRow()][kingPosition.getColumn()] == true) {
				return true;
			}
		}
		return false;
